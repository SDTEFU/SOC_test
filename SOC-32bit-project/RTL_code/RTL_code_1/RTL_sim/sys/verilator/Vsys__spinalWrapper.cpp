...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.io_ckl );
      signalAccess[1] = new CDataSignalAccess( top.io_rst_n );
      signalAccess[2] = new CDataSignalAccess( top.io_sys_clk );
      signalAccess[3] = new CDataSignalAccess( top.io_sys_rst_n );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/adgert/Desktop/test/git-project/SOC_test/SOC-32bit-project/RTL_code/RTL_code_1/./RTL_sim/sys/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/adgert/Desktop/test/git-project/SOC_test/SOC-32bit-project/RTL_code/RTL_code_1/./RTL_sim/sys/") + name + ".dat").c_str());
      #endif
    }
